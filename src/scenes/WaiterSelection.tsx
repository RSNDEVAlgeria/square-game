...
export function WaiterSelection({ onSelect, onStart, selectedWaiter }: WaiterSelectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* Waiter Grid - Scrollable with proper padding */}
      ...
      {selectedWaiter && (
        <div
          className="mb-3 p-3 rounded-xl text-center animate-in fade-in slide-in-from-bottom-2"
      ...
      {/* Start Button - Fixed at bottom with proper spacing */}
